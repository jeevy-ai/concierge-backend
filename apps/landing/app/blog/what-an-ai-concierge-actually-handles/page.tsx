    ...
    <main className="min-h-screen bg-[#f5f4f0] px-6 py-16">
      <article className="mx-auto max-w-2xl">
        ...
        <div className="space-y-6 text-[17px] leading-relaxed text-gray-700">
          ...
          <p>
            We&apos;re deliberate about scope — not because we can&apos;t build more, but because
            clarity is the point. People who trust a concierge need to know exactly what they can
            hand off and what they need to own. Ambiguity erodes that trust faster than any
          ...
          <p>
            ...
            <strong>coordination cost</strong> outweighs the <strong>decision cost</strong>. The
            hard part isn&apos;t figuring out what to do — it&apos;s the back-and-forth, the
            follow-through, and the context-switching that burns your day.
          </p>

          <p>
            <strong>Scheduling and calendar management.</strong> Finding times, sending holds,
            rescheduling conflicts, blocking focus time. Not just for you — across your team and
            with external contacts who don&apos;t use the same tools you do.
          </p>
          <p>
            <strong>Meeting prep and follow-up.</strong> Summarizing the agenda, pulling background
            on attendees, and turning action items into tracked tasks after the call ends. The part
          ...
          <p>
            <strong>Email drafting and inbox triage.</strong> First drafts on routine
            correspondence, flagging what needs a real response versus what can be handled or
            delegated, and keeping threads from going quiet when they shouldn&apos;t.
          </p>
          <p>
            <strong>Travel and logistics coordination.</strong> Searching options, compiling
            itineraries, flagging conflicts with existing commitments, and managing the logistics
            tail after you&apos;ve made a decision.
          </p>
          <p>
            <strong>Reminders, nudges, and follow-up tracking.</strong> The steady-state work of
            keeping commitments alive — surfacing things before they slip, following up with
            external contacts when threads go dark.
          </p>
          <p>
            What these share: they&apos;re defined, they&apos;re delegatable, and done well, they
            compound. An hour of Jeevy handling calendar work frees an hour for the work only you
            can do.
          </p>
          ...
          <p>
            ...
            information and frame options — but it doesn&apos;t make calls that require
            accountability, judgment under uncertainty, or lived context about your company and
            relationships.
          </p>
          <p>
            <strong>Sensitive relationship conversations.</strong> Feedback conversations,
            performance discussions, and emotionally complex communications stay in your hands.
            AI-generated empathy is a known failure mode. Jeevy won&apos;t put words in your mouth
            when getting the tone wrong costs trust.
          </p>
          <p>
            <strong>Work that requires your authentic voice.</strong> Jeevy can draft, but you own
            anything that shapes how the market sees you — final copy, thought leadership,
            positioning statements. Iterating with AI is fine. Fully outsourcing your perspective
            isn&apos;t.
          </p>
          <p>
            <strong>Financial transactions and binding commitments.</strong> Jeevy won&apos;t
            approve spend, move money, or commit on your behalf.
          </p>
          <p>
            <strong>Open-ended creative direction without a brief.</strong> If you don&apos;t know
            what you want yet, Jeevy isn&apos;t the right first step. It&apos;s a force-multiplier
            on clear intent — not a substitute for figuring out what matters.
          </p>
          ...
          <p>
            That&apos;s only possible if the scope is honest. We&apos;d rather tell you
            &ldquo;that&apos;s not in Jeevy&apos;s lane&rdquo; than have you lose a client because a
            concierge tool treated an emotionally complex email like a scheduling request.
          </p>
          <p>
            The question we ask internally isn&apos;t &ldquo;can AI technically do this?&rdquo;
            It&apos;s: <strong>is this the kind of task where AI failure is recoverable?</strong>
          </p>
          <p>A scheduling conflict is recoverable. A relationship misstep is not.</p>
          ...
          <p>
            ...
            advisor — that&apos;s not us. We&apos;ll be specific about that every time, because
            specificity is what makes the parts we <em>do</em> handle actually trustworthy.
          </p>
        </div>
